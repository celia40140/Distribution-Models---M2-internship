...
gam_function_cv <- function(occurrence,
                         covariates,
                         species_name,
                         base_dir){
...
# }else{
#
#   test <- unique(occurrence_validation$protection) %in% unique(occurrence_final$protection) # test if you have the same factors in the fitting and validation set
#
#   if(any(test == FALSE)){
#
#     occurrence_validation <- occurrence_validation |>
...
# 
# 
# gam_function <- function(occurrence,
#                          covariates,
#                          species_name,
#                          base_dir){
# 
...
# covnames_new <- covnames_new[-which(covnames_new %in% c("Row.names"))]
# #covnames_new <- c(covnames_new, "factor(protection)")
# 
